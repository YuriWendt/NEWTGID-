...
export const GlobalStyle = createGlobalStyle`
  body {
    ...
    background: url(${theme.img.background});
...
export const CellValue = styled.div<{ value: number }>`
     ${props => props.value && props.value > 0 ? css`color: ${theme.colors.green.color100};` : css`color: ${theme.colors.red.color100};`};
 `
...
export const CellStatus = styled.div<{ status?: number }>`
    ...
    padding: 4px 8px;
    text-align: center;
    ${props => props.status === 1 && css`background-color: ${theme.colors.yellow}`}
    ${props => props.status === 2 && css`background-color: ${theme.colors.green.color60}`}
    ${props => props.status === 3 && css`background-color: ${theme.colors.red.color60}`}
    ${props => props.status === 4 && css`background-color: ${theme.colors.blue.color60}`}
    ${props => props.status === 5 && css`background-color: ${theme.colors.red.color60}`}
    ${props => props.status === 6 && css`background-color: ${theme.colors.secondary.color60}`}
`